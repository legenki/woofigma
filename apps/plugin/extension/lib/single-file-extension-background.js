!(function () {
      ...
      : e.method.endsWith(".disable")
        ? ((async function () {
            ...
            (Object.keys(t).forEach(
              ...
              e &&
                (browser.bookmarks.onCreated.removeListener(Wa),
                browser.bookmarks.onMoved.removeListener(Da)));
          })(),
          {})
        : void 0;
  }
  async function Ma() {
    ...
    (Object.keys(t).forEach((a) => {
      ...
      e &&
        (browser.bookmarks.onCreated.addListener(Wa),
        browser.bookmarks.onMoved.addListener(Da)));
  }
  ...
  async function Wa(e, t) {
    (La.add(e), await Fa(e, t.url, t));
  }
  async function Da(e, t) {
    if (La.has(e)) {
      const a = await browser.bookmarks.get(e);
      a[0] && (await Fa(e, a[0].url, t));
    }
  }
  async function Fa(e, t, a) {
    ...
    if (o.saveCreatedBookmarks) {
      const i = await (async function e(t, a = []) {
        ...
        s = o.allowedBookmarkFolders.toString(),
        c = i.find((e) => o.allowedBookmarkFolders.includes(e)),
        l = o.ignoredBookmarkFolders.toString(),
        d = i.find((e) => o.ignoredBookmarkFolders.includes(e));
      if (((s && c) || !s) && ((l && !d) || !l))
        if (n.length && n[0].url == t)
          (La.delete(e), ba(n, { bookmarkId: e, bookmarkFolders: i }));
        else {
    ...
    async upload(e = 1) {
      ...
      if (o.files.length)
        if ("overwrite" == this.filenameConflictAction)
          ((a = "PATCH"), (t = o.files[0].id), (this.metadata.parents = null));
        else if (this.filenameConflictAction == Oa) {
          ...
          const o = t + " (" + e + ")." + a,
            r = Ha(
              await fetch(
                Ba +
                  `?q=name = '${o}' and trashed != true and '${this.metadata.parents[0]}' in parents`,
                {
                  headers: {
                    Authorization: "Bearer " + this.token,
                    "Content-Type": "application/json",
          ...
          if ("prompt" == this.filenameConflictAction) {
            ...
            return ((this.filenameConflictAction = Oa), this.upload(e));
          }
    ...
    if (n.length) {
      ...
      for (const i of n) {
        ...
        if (n) r = n;
          ...
          try {
            ((r = await $a(e, i, r)), e.folderIds.set(o, r));
          } catch (n) {
            if ("path_not_found" == n.message && a)
              return (e.folderIds.clear(), Ka(e, t, !1));
            throw n;
          }
      }
    }
    ...
    async upload() {
      const e = nn(
          await fetch("https://api.dropboxapi.com/2/files/search_v2", {
            ...
            body: on({ query: this.metadata.name, options: { filename: !0 } }),
          }),
        ),
        t = await an(e);
      if (t.matches.length)
        if (this.filenameConflictAction == Za)
          if (this.prompt) {
            const e = await this.prompt(this.metadata.name);
            if (!e) return t;
            this.metadata.name = e;
          } else this.filenameConflictAction = Xa;
      ...
      const a = nn(
          await fetch(
            "https://content.dropboxapi.com/2/files/upload_session/start",
            {
              ...
              headers: {
                Authorization: "Bearer " + this.token,
                "Dropbox-API-Arg": on({ close: !1 }),
                "Content-Type": "application/octet-stream",
              },
            },
          ),
        ),
        n = (await an(a)).session_id;
        ...
        headers: {
          ...
          "Dropbox-API-Arg": on({
            ...
            commit: {
              ...
              autorename: e.filenameConflictAction == Xa,
            },
          }),
        },
      },
    );
    if (200 == r.status) return an(r);
    if (409 == r.status && e.filenameConflictAction == Za)
  ...
  function on(e) {
    return JSON.stringify(e).replace(Qa, function (e) {
  ...
  async function bn(e, t, a) {
    ...
    try {
      if ("overwrite" == o) {
        ...
        if (n.status >= wn) {
          if (((n = await l(e, "DELETE")), n.status >= wn))
            throw new Error(un + n.status);
          return await bn(e, t, a);
        }
      } else {
        let n = await l(e, "HEAD");
        if (200 == n.status) {
          if ("uniquify" == o || (o == sn && !r)) {
            const {
              ...
              let o;
              return (
                ({ filenameWithoutExtension: t, indexFilename: o } = (function (
                  e,
                ) {
                  const t = e.match(fn);
                  let a = 0;
                  if (t && t.length > 1) {
                    ...
                    Number.isNaN(n) || ((a = n), (e = e.replace(fn, rn)));
                  }
                  return { filenameWithoutExtension: e, indexFilename: a };
                })(t)),
                { filenameWithoutExtension: t, extension: a, indexFilename: o }
              );
            })(e);
            return (
              (a.indexFilename = r + 1),
              await bn(
                (function (e, t) {
                  return e + " (" + a.indexFilename + ")" + (t ? dn + t : rn);
                })(n, o),
                t,
                a,
              )
          ...
          if (o == sn) return (e = await r(e)) ? bn(e, t, a) : n;
          if ("skip" == o) return n;
        } else {
          if (404 == n.status) {
            if (((n = await l(e, "PUT", t)), n.status >= wn && !s)) {
              if (e.includes(ln))
                return (
                  await (async function () {
                    const t = e.split(ln);
                    ...
                    for (const e of t)
                      if (e) {
                        a += e;
                        if (404 == (await l(a, mn)).status) {
                          const e = await l(a, hn);
                          if (e.status >= wn) throw new Error(un + e.status);
                        }
                        a += ln;
                      }
                  })(),
          ...
          if (n.status >= wn) throw new Error(un + n.status);
        }
      }
    } catch (e) {
  ...
  class Mn {
    ...
    async upload(e, t, a) {
      ...
      return (async function (e, t, a, n, o, r) {
        ...
        for (; Rn; ) await Rn;
        try {
          Rn = await d({ path: n, content: o });
        } finally {
          Rn = null;
        }
        return { url: `${Cn}/${e}/${t}/${Pn}/${a}/${n}` };
        async function d({ path: n, content: o, message: f = "", sha: h }) {
          try {
            const e = await w(
                "PUT",
                JSON.stringify({ content: o, message: f, branch: a, sha: h }),
              ),
              t = await e.json();
            if (422 == e.status) {
              if (i == kn) {
                const e = await w("GET"),
                  t = (await e.json()).sha;
                return await d({ path: n, content: o, message: f, sha: t });
              }
              if (i == vn) {
                const {
                ...
                return (
                  (r.indexFilename = a + 1),
                  (n = m(e, t)),
                  await d({ path: n, content: o, message: f })
                );
              }
              if (i == yn) return t;
              if (i == An)
                return s
                  ? (n = await s(n))
                    ? await d({ path: n, content: o, message: f })
                    : t
                  : ((r.filenameConflictAction = vn),
                    await d({ path: n, content: o, message: f }));
            }
            if (e.status < 400) return t;
            throw new Error(t.message);
          } catch (e) {
            if (e.name != In) throw e;
          }
          function w(a, o) {
            return fetch(`${Sn}/${En}/${e}/${t}/${Ln}/${n}`, {
              method: a,
              headers: l,
              body: o,
              signal: c,
        ...
        function u(e) {
          let t = e,
            a = gn;
          const n = e.lastIndexOf(xn);
          let o;
          return (
            n > -1 && ((t = e.substring(0, n)), (a = e.substring(n + 1))),
            ({ filenameWithoutExtension: t, indexFilename: o } = f(t)),
            { filenameWithoutExtension: t, extension: a, indexFilename: o }
          );
        }
        function f(e) {
          ...
          if (t && t.length > 1) {
            const n = Number(t[t.length - 1]);
            Number.isNaN(n) || ((a = n), (e = e.replace(Tn, gn)));
          }
          return { filenameWithoutExtension: e, indexFilename: a };
        }
        function m(e, t) {
          return e + " (" + r.indexFilename + ")" + (t ? xn + t : gn);
        }
  ...
  class Nn {
    constructor(e, t, a, n, o = "s3.amazonaws.com") {
      ((this.api = new qn({
        ...
        (this.headObjectSupported = !0),
        (this.listObjectsSupported = !0));
    }
    async upload(e, t, a) {
      const { filenameConflictAction: n, prompt: o } = a;
      ((this.controller = new AbortController()),
        (a.signal = this.controller.signal));
      try {
        if ("overwrite" == n)
          return this.api.putObject({ path: e }, { body: await _n(t) });
        {
          let r;
          if (
            (this.headObjectSupported &&
              (r = await this.api.headObject({ path: e }, a)),
            (this.headObjectSupported && 403 != r.status) ||
              ((this.headObjectSupported = !1),
              this.listObjectsSupported &&
                (r = await this.api.listObjects({ path: e }, a)),
              (this.listObjectsSupported && 403 != r.status) ||
                ((this.listObjectsSupported = !1),
                (r = await this.api.getObject({ path: e }, a)))),
            200 != r.status)
          ) {
            if (404 == r.status)
              return (
                (t = new Uint8Array(await t.arrayBuffer())),
                this.api.putObject({ path: e }, { body: await _n(t) })
              );
          ...
          if ("prompt" == n)
            return o
              ? (e = await o(e))
                ? this.upload(e, t, a)
                : r
              : ((a.filenameConflictAction = Wn), this.upload(e, t, a));
          if (n == Wn) {
            const {
              filenameWithoutExtension: n,
              extension: o,
              ...
              return (
                ({ filenameWithoutExtension: t, indexFilename: o } = (function (
                  ...
                  if (t && t.length > 1) {
                    const n = Number(t[t.length - 1]);
                    Number.isNaN(n) || ((a = n), (e = e.replace(Fn, "")));
                  }
                  return { filenameWithoutExtension: e, indexFilename: a };
                })(t)),
                { filenameWithoutExtension: t, extension: a, indexFilename: o }
  ...
  class qn {
    ...
    async putObject({ path: e }, { headers: t = {}, body: a }) {
      return zn(this, { path: e }, { method: "PUT", headers: t, body: a });
    }
    async getObject({ path: e }, { headers: t = {} } = {}) {
      return zn(this, { path: e }, { method: "GET", headers: t });
    }
    async headObject({ path: e }, { headers: t = {} } = {}) {
      return zn(this, { path: e }, { method: "HEAD", headers: t });
    }
    async listObjects(
      { path: e },
      {
      ...
      return (
        s.set("list-type", "2"),
        a && s.set("continuation-token", a),
        n && s.set("delimiter", n),
        o && s.set("encoding-type", o),
        r && s.set("prefix", r),
        i && s.set("max-keys", i),
        zn(this, { path: e, searchParams: s }, { method: "GET", headers: t })
      );
    }
  }
  async function zn(
    { region: e, bucket: t, accessKey: a, secretKey: n, domain: o },
    { path: r = "/", searchParams: i = new URLSearchParams() },
    { method: s, headers: c = {}, body: l },
  ) {
    const d = (function (e) {
      const t = new Date(e);
    ...
    (r.startsWith("/") || (r = "/" + r),
      (c.host = t + "." + o),
      l && (c["content-length"] = l.byteLength),
      (c["x-amz-content-sha256"] = await Vn(l)),
      (c["x-amz-date"] = d),
      (c.authorization =
        On +
        " Credential=" +
        ...
        ",Signature=" +
        (await (async function (
          { region: e, secretKey: t, service: a },
          { path: n, searchParams: o },
          { method: r, headers: i, body: s, isoDate: c },
        ) {
          const l = await (async function (e, t, a, n, o, r, i, s) {
            ...
            d = await (async function (e, t, a, n) {
              const o = await Jn(Xn(Bn + e), Xn(t.substring(0, 8))),
                r = await Jn(o, Xn(a)),
                i = await Jn(r, Xn(n));
              return Jn(i, Xn(jn));
            })(t, c, e, a);
          return Zn(await Jn(d, Xn(l)));
        })(
          { region: e, secretKey: n, service: "s3" },
          { path: r, searchParams: i },
          { method: s, headers: c, body: l, isoDate: d },
        ))));
    const u = "https://" + t + "." + o + r + (i.size ? "?" + i : ""),
      f = { method: s, headers: c };
    return (l && (f.body = l), fetch(u, f));
  }
  function Kn(e) {
  ...
  async function Vn(e = new Uint8Array(0)) {
    return Zn(await Hn(e));
  }
  function Gn(e, t, a) {
    return e.substring(0, 8) + "/" + t + "/" + a + "/" + jn;
  }
  async function Hn(e) {
    return crypto.subtle.digest("SHA-256", e);
  }
  async function Jn(e, t) {
    const a = { name: "HMAC", hash: { name: "SHA-256" } },
  ...
  class ro {
    ...
    async upload(e, t, a) {
      ...
      return (
        (this.controller = new AbortController()),
        (a.signal = this.controller.signal),
        (a.serverUrl = this.serverUrl),
        (a.authToken = this.authToken),
        (a.getRequestId = () => ++this.requestId),
        (n = t instanceof Blob ? await t.text() : t),
        io(e, n, a)
      );
    }
    abort() {
    ...
    try {
      const l = await (async function (e, t, a, n, o) {
        const r = {
            ...
            id: o(),
            method: "tools/call",
            params: { name: "get_file_info", arguments: { path: a } },
          },
          i = { [ao]: no, Accept: "application/json, text/event-stream" };
        ...
        if (!s.ok)
          throw new Error(`MCP server error: ${s.status} ${s.statusText}`);
        const c = await s.json();
        if (c.error) return { exists: !1 };
        if (c.result && c.result.isError) return { exists: !1 };
        if (c.result) return { exists: !0 };
        return { exists: !1 };
      })(i, s, e, r, c);
      if (l.exists) {
        if ("skip" == n) return { url: e, skipped: !0 };
        if ("overwrite" == n);
        else {
          if (n == Yn) {
            const {
              ...
              return (
                ({ filenameWithoutExtension: t, indexFilename: o } = (function (
                  ...
                  if (t && t.length > 1) {
                    const n = Number(t[t.length - 1]);
                    Number.isNaN(n) || ((a = n), (e = e.replace(to, "")));
                  }
                  return { filenameWithoutExtension: e, indexFilename: a };
                })(t)),
                { filenameWithoutExtension: t, extension: a, indexFilename: o }
          ...
          if ("prompt" == n)
            return o
              ? (e = await o(e))
                ? await io(e, t, a)
                : { url: e, skipped: !0 }
              : ((a.filenameConflictAction = Yn), await io(e, t, a));
        }
      }
      const d = await (async function (e, t, a, n, o, r) {
        const i = {
            jsonrpc: oo,
            id: r(),
            method: "tools/call",
            params: { name: "write_file", arguments: { path: a, content: n } },
          },
          s = { [ao]: no, Accept: "application/json, text/event-stream" };
        ...
        if (!c.ok)
          throw new Error(`MCP server error: ${c.status} ${c.statusText}`);
        const l = await c.json();
        if (l.error) throw new Error(l.error.message);
        return { success: !0 };
      })(i, s, e, t, r, c);
      if (d.success) return { url: e };
      throw new Error(d.error || "Failed to write file via MCP");
    } catch (e) {
      if ("AbortError" != e.name) throw e;
    }
  }
  ...
  let tr =
    ...
    ar = "VQJ8Gq8Vxx72QyxPyeLtWvUt";
  const nr = browser.runtime.getManifest().oauth2;
  nr && ((tr = nr.client_id), (ar = nr.client_secret));
  const or = new (class {
      constructor(e, t, a) {
        ((this.clientId = e),
          (this.clientKey = t),
              ...
              : (async function (e, t) {
                  ...
                  try {
                    ...
                    if (
                      ...
                      if (a) return ((t.code = a), await qa(e, t));
            ...
            : (async function (e, t) {
                ...
                try {
                  ...
                  if (
                    ...
                    if (a) return ((t.code = a), await en(e, t));
                    throw new Error("code_required");
                  }
                  throw n;
                }
  ...
  async function Cr(e, t) {
    ...
    if (n) {
      ...
      (Vt(a, 1, !0),
        ...
        (n.tabIndex = t.index));
      try {
        if (n.autoSaveExternalSave)
          await (async function (e) {
            let t;
            e.autoSaveExternalSave = !1;
            try {
              t = await browser.runtime.sendNativeMessage(
                "singlefile_companion",
                { method: "externalSave", pageData: e },
              );
            } catch (e) {
              if (!e.message || !e.message.includes("Native host has exited"))
                throw e;
            }
            if (t && t.error) throw new Error(t.error + " (Companion)");
          })(n);
          ...
          if (!r) {
            if (n.saveToGDrive) {
              const t = await (await fetch(o.url)).blob();
              await pr(
                e.taskId,
                lr(o.filename),
                t,
            ...
            if (n.saveToDropbox) {
              const t = await (await fetch(o.url)).blob();
              await br(e.taskId, lr(o.filename), t, {
                filenameConflictAction: n.filenameConflictAction,
              });
            } else if (n.saveWithWebDAV) {
              const t = await (await fetch(o.url)).blob();
              await hr(
                e.taskId,
                lr(o.filename),
            ...
            } else if (n.saveWithCompanion && !n.compressContent) {
              const e = await (await fetch(o.url)).text();
              await Ea({
                filename: o.filename,
                content: e,
                title: o.title,
              ...
              await kr(
                ...
                t,
                n.url,
                n.saveToRestFormApiToken,
                n.saveToRestFormApiUrl,
                n.saveToRestFormApiFileFieldName,
                n.saveToRestFormApiUrlFieldName,
              );
            } else if (n.saveToS3) {
              const t = await (await fetch(o.url)).blob();
              await mr(
